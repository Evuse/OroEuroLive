...
document.querySelector('#app').innerHTML = `
  <header class="topbar">
    ...
    <div class="top-actions"><span class="market-pill"><i></i> Mercato aperto</span><button class="icon-button" aria-label="Impostazioni">•••</button></div>
  </header>
  <main>
...
async function refreshMarket() {
  try {
    ...
    render();
  } catch { el('updated').textContent = 'ultimo dato'; }
}
